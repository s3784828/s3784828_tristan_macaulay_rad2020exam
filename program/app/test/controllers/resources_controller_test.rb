...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference('Resource.count') do
      post resources_url, params: { resource: { city_name: @resource.city_name, offset: @resource.offset } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { city_name: @resource.city_name, offset: @resource.offset } }
