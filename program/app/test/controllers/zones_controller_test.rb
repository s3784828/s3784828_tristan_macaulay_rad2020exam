...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference('Zone.count') do
      post zones_url, params: { zone: { abbr: @zone.abbr, isdt: @zone.isdt, offset: @zone.offset, text: @zone.text, utc: @zone.utc, value: @zone.value } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { abbr: @zone.abbr, isdt: @zone.isdt, offset: @zone.offset, text: @zone.text, utc: @zone.utc, value: @zone.value } }
